...
// Uso:
//
//	go run ./cmd/loader -file data/crimes.csv -workers 8 -chunk 5000
//	go run ./cmd/loader -file data/crimes.csv -benchmark
//
// Flags:
//
//	-file      Ruta al archivo CSV del dataset de Chicago Crimes
//	-workers   Número de goroutines trabajadoras (default: NumCPU)
//	-chunk     Líneas CSV por bloque de trabajo (default: 5000)
//	-output    Directorio de salida (default: output/)
//	-benchmark Ejecuta comparativa secuencial vs. concurrente
//	-verbose   Imprime progreso en tiempo real
package main
