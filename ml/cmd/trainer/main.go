// Comando trainer: entrena el Random Forest en paralelo sobre los
// datos limpios producidos por el pipeline de carga.
//
// Uso:
//
//	go run ./cmd/trainer -data <archivo.csv|archivo.json> [-trees 100] [-workers 8]
//
// Acepta dos formatos de entrada:
//   - CSV crudo del Chicago Data Portal (se carga con el ConcurrentLoader)
//   - JSON con un arreglo de CleanRecord (ej. output/clean_records_sample.json)
package main
