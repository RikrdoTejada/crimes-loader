...
// LoadFile carga todos los registros desde un archivo CSV.
// Devuelve un slice de punteros a CleanRecord, una cantidad de errores,
// y un error si no se puede abrir el archivo.
