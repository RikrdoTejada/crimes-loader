...
// buildTree construye un árbol de decisión sobre los índices idx del
// dataset ds, usando impureza de Gini ponderada por clase.
// rng es el generador aleatorio propio de la goroutine (no compartido,
// para evitar condiciones de carrera sobre el estado del generador).
...
// weightedGiniSplit calcula la impureza de Gini ponderada del split
// (f, thr): suma ponderada de la impureza de cada partición.
// Los pesos de clase W0/W1 hacen que los errores sobre la clase
// minoritaria penalicen más, implementando el class weighting.
